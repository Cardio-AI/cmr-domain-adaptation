...
def create_affine_transformer_max_unet_predictions(config, metrics=None, networkname='affine_transformer',
                                                   single_model=True, supervision=False, unet=None):
    """
    ...
    with strategy.scope():
        ...
        dense = tensorflow.keras.layers.Dense(256, kernel_initializer=kernel_init, activation=activation,
                                              name='dense1')(dense)
        m_raw = tensorflow.keras.layers.Dense(9, kernel_initializer=RandomNormal(mean=0.0, stddev=1e-10),
                                              activation=activation, name='dense2')(dense)
...
def create_spatial_unet(config, metrics=None, networkname='enc_st_unet_st', single_model=True, supervision=False,
                        unet_2d=None):
    """
    ...
    with strategy.scope():
        ...
        rev_mask = [
            nrn_layers.SpatialTransformer(interp_method='nearest', indexing=indexing, ident=False, fill_value=0)(
...
def create_affine_cycle_transformer(config, metrics=None, networkname='affine_cycle_transformer', unet=None):
    ...
    with strategy.scope():
        ...
        m_raw = tensorflow.keras.layers.Dense(256, kernel_initializer=kernel_init, activation=activation,
                                              name='dense1')(m_raw)
        m_raw = tensorflow.keras.layers.Dense(9, kernel_initializer=RandomNormal(mean=0.0, stddev=1e-10),
        ...
        if unet:
            ...
            losses = {'ax2sax': metr.loss_with_zero_mask(mask_smaller_than=0.01, weight_inplane=True,
                                                         xy_shape=input_shape[-2]),
                      'sax2ax': metr.loss_with_zero_mask(mask_smaller_than=0.01, weight_inplane=True,
                                                         xy_shape=input_shape[-2]),
...
def create_affine_cycle_transformer_test(config, metrics=None, networkname='affine_cycle_transformer', unet=None):
    ...
    - Loss_focus =  number of predictable ventricle voxels according to the pre-trained u-net
    """
...
def create_affine_transformer_baseline(config, metrics=None, networkname='affine_transformer_baseline', unet=None):
    ...
    with strategy.scope():
        ...
        dense = tensorflow.keras.layers.Dense(256, kernel_initializer=kernel_init, activation=activation,
                                              name='dense1')(dense)
        m_raw = tensorflow.keras.layers.Dense(6, kernel_initializer=RandomNormal(mean=0.0, stddev=1e-10),
                                              activation=activation, name='dense2')(dense)
        ...
        if unet:
            ...
            mask_prob = nrn_layers.SpatialTransformer(interp_method='nearest', indexing=indexing, ident=False,
                                                      fill_value=0, name='sax_pred2ax')([mask_prob, m_inverse])
...
def create_affine_transformer_with_unet(config, metrics=None, networkname='affine_transformer', single_model=True,
                                        supervision=False):
    """
